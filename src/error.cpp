...
namespace qbit
{
	struct qbit_error_category : boost::system::error_category
	{
		virtual const char* name();
		virtual std::string message(int ev);
		virtual boost::system::error_condition default_error_condition(int ev) 
		{ return boost::system::error_condition(ev, *this); }
	};

	const char* qbit_error_category::name() const 
	{
		return "qbit error";
	}

	std::string qbit_error_category::message(int ev) const 
	{
...
//bdecode errors
	...
	qbit_exception::~qbit_exception() throw()
	{
		free(m_msg);
	}
}
